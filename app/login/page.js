        ...
        <div className="flex items-center justify-center min-h-[70vh] px-4 py-12">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 p-8 md:p-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-3 font-medium">Continue your coding journey.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {error && (
                        <div className="flex items-center space-x-2 text-red-600 dark:text-red-400 text-sm bg-red-50 dark:bg-red-900/10 p-4 rounded-2xl animate-shake">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center space-x-2 active:scale-[0.98] disabled:opacity-70"
                    >
                        {loading ? (
